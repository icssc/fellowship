...
This unit we are going to briefly cover GitHub, READMEs, Markdown, and GitHub Profiles. This is a shorter unit to get the Fellowship started. You may even already be familiar with some of these concepts. 

## Unit 1 Lecture Video

<Video src="https://www.youtube.com/embed/bJKevRR554o" />
...
| \`code\` | `code` |
| \[Link\](https://studentcouncil.ics.uci.edu) | [Link](https://studentcouncil.ics.uci.edu) |
...
Your assignment for this unit is to create a [GitHub account](https://github.com/signup) and add a GitHub Profile README. 
Already have one? Great! You can relax or continue to improve it.
...
Complete the [Google Form](https://forms.gle/sXfMDESDFr9pHhaNA). Please use your UCI email.

<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdJyqKLOExFS0SLgVcfeZBEsc750u4buL1yEm9k9vB9a5fOAw/viewform?embedded=true" width="100%" height="1500" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
