...
![Clone your forked project](../static/img/unit10/clone-fork.png)
...
![Open a pull request](../static/img/unit10/open-pr.png)

![Create a pull request](../static/img/unit10/create-pr.png)
...
- [PeterPortal API Issues](https://github.com/icssc/peterportal-public-api/issues?q=is%3Aissue+is%3Aopen+label%3A"good+first+task")
- [PeterPortal Client Issues](https://github.com/icssc/peterportal-client/issues?q=is%3Aissue+is%3Aopen+label%3A"good+first+task")
- [Zotistics Issues](https://github.com/icssc/Zotistics/issues?q=is%3Aissue+is%3Aopen+label%3A"good+first+task")
...
Complete the [Google Form](https://forms.gle/oxSxaeJW9c7th5FH9).
...
<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd79Z281FbUYdX3crbO7C2LdA3-Gdka5qhOdc70dznewQi8Cg/viewform" width="100%" height="1056" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
