...
This unit we'll get started on your personal website and cover the basics of HTML and CSS.
...
This unit, we are going to start development on your very own personal website and get it deployed with GitHub Pages! The requirements to complete the assignment are fairly simple but try your best to make your site look good :)
...
Complete the [Google Form](https://forms.gle/cJmLxnWmWW8jJB3U9).

<iframe src="https://docs.google.com/forms/d/e/1FAIpQLSd1QIHj9v50Ca8Op50rd9mca-eWkwnaZ_0fbJQlX6eCF5tDSg/viewform?embedded=true" width="100%" height="1300" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe>
