...
This week, we'll be learning about TypeScript a strict superset of JavaScript.
...
We learned about TypeScript this week, but for this topic, there will only be a quiz. 
